...
def deleteitem():
    e1 = entry1.get()
    with open(r"database_proj") as f, open(r"database_proj1") as working:
        for line in f:
...
def nextitem():
    ...
    try:
        ...
        messagebox.showinfo("Title", "Sorry, No more records available")
...
def updateitem():
    ...
    e4 = entry4.get()
    e5 = entry5.get()
    with open(r"database_proj") as f1, open(r"database_proj1") as working:
        for line in f1:
            if str(e1) not in line:
                working.write(line)
            else:
...
def searchitem():
    ...
    with open(r"database_proj") as working:
        ...
        try:
            ...
            messagebox.showinfo("Title", "End of file.")
    working.close()
...
label1 = Label(root, text="Enter Item Name:", bg="red", relief="ridge", height="1", font=("Times, 10"), width="25")
entry1 = Entry(root, font=("Times", 12))

label2 = Label(root, text="Enter Item Price:", bd="2", bg="red", relief="ridge", height="1", font=("Times, 10"), width="25")
entry2 = Entry(root, font=("Times", 12))

label3 = Label(root, text="Enter Item Quantity:", bd="2", bg="red", relief="ridge", height="1", font=("Times, 10"), width="25")
entry3 = Entry(root, font=("Times", 12))

label4 = Label(root, text="Enter Item Category:", bd="2", bg="red", relief="ridge", height="1", font=("Times, 10"), width="25")
entry4 = Entry(root, font=("Times", 12))

label5 = Label(root, text="Enter Item DISCOUNT:", bd="2", bg="red", relief="ridge", height="1", font=("Times, 10"), width="25")
...
# commented out - some compilers might not work with the brackets in the command param - These were causing an error initially that wasn't running our app properly - here for archive and reference purposes
# button1 = Button(root, text="ADD ITEM", bg="white", fg="black", width=20, font=("Times", 12), command=additem())
# button2 = Button(root, text="DELETE ITEM", bg="white", fg="black", width=20, font=("Times", 12), command=deleteitem())
# button3 = Button(root, text="VIEW FIRST ITEM", bg="white", fg="black", width=20, font=("Times", 12), command=firstitem())
# button4 = Button(root, text="VIEW NEXT ITEM", bg="white", fg="black", width=20, font=("Times", 12), command=nextitem())
...
# Uncomment after you add backend logic to command variable. Need to temp comment out to work on GUI
# button1 = Button(root, text="ADD ITEM", bg="white", fg="black", width=20, font=("Times", 20), command=additem)
# button2 = Button(root, text="DELETE ITEM", bg="white", fg="black", width=20, font=("Times", 20), command=deleteitem)
# button3 = Button(root, text="VIEW FIRST ITEM", bg="white", fg="black", width=20, font=("Times", 20), command=firstitem)
# button4 = Button(root, text="VIEW NEXT ITEM", bg="white", fg="black", width=20, font=("Times", 20), command=nextitem)
# button5 = Button(root, text="VIEW PREVIOUS ITEM", bg="white", fg="black", width=20, font=("Times", 20), command=previousitem)
# button6 = Button(root, text="VIEW LAST ITEM", bg="white", fg="black", width=20, font=("Times", 20), command=lastitem)
# button7 = Button(root, text="UPDATE ITEM", bg="white", fg="black", width=20, font=("Times", 20), command=updateitem)
# button8 = Button(root, text="SEARCH ITEM", bg="white", fg="black", width=20, font=("Times", 20), command=searchitem)
# button9 = Button(root, text="CLEAR SCREEN", bg="white", fg="black", width=20, font=("Times", 20), command=clearitem)